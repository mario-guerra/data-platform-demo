...
class ModelPredictor:
        ...
        try:
            ...
            if experiment:
                ...
                if not runs.empty:
                    ...
                    model_uri = (
                        f"runs:/{latest_run.run_id}/random_forest_price_predictor"
                    )
        ...
        try:
            ...
            confidence = min(
                ...
                max(
                    0.1,
                    1.0
                    - abs(prediction - self.fallback_mean_price)
                    / self.fallback_mean_price,
                ),
            )
    ...
    def prepare_features(self, order_data: Dict[str, Any]) -> Optional[list]:
        ...
        try:
            ...
            currency_encoding = {"USD": 0, "EUR": 1, "GBP": 2, "JPY": 3, "CAD": 4}
...
def test_local_server():
    ...
    # Test data
    test_orders = [
        {"product": "laptop", "region": "us-east", "currency": "USD", "quantity": 1},
        {
            "product": "smartphone",
            "region": "eu-central",
            "currency": "EUR",
    ...
    event = {"body": json.dumps(test_orders[0])}
